...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1149.0, 27.5, 82.0, 20.0 ],
					"text" : "Views :"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1149.0, 284.5, 82.0, 20.0 ],
					"text" : "voice.2 view"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1149.0, 80.0, 82.0, 20.0 ],
					"text" : "voice.1 view"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1195.0, 796.5, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1195.0, 611.0, 100.0, 22.0 ],
					"text" : "route /fader_1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1195.0, 643.0, 20.0, 140.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1149.0, 304.5, 293.0, 159.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1149.0, 100.0, 293.0, 159.0 ],
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 140.0, 67.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 572.0, 334.0, 181.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 462.75, 334.0, 107.25, 22.0 ],
									"text" : "/SESSION/SAVE"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 38.0, 242.0, 100.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 140.0, 298.0, 100.0, 22.0 ],
									"text" : "conformpath"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 163.0, 214.0, 162.0, 70.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 241.0, 116.0, 264.0, 34.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 111.0, 50.0, 22.0 ],
									"text" : "path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 334.0, 160.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 175.0, 285.0, 22.0 ],
									"text" : "sprintf symout %sO-S-C_OSSIA-Max_example.json"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 140.0, 139.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 765.0, 150.0, 20.0 ],
					"text" : "to openStageControl only"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 705.0, 69.0, 22.0 ],
					"text" : "/fader_1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 741.0, 150.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-28::obj-1" : [ "Carrier frequency", "Carrier frequency", 0 ],
			"obj-28::obj-2" : [ "Cutoff", "Cutoff", 0 ],
			"obj-28::obj-3" : [ "Index", "Index", 0 ],
			"obj-28::obj-4" : [ "Gain", "Gain", 0 ],
			"obj-28::obj-6" : [ "Pan", "Pan", 0 ],
			"obj-28::obj-7" : [ "live.numbox", "live.numbox", 0 ],
			"obj-28::obj-8" : [ "Ratio", "Ratio", 0 ],
			"obj-29::obj-1" : [ "Carrier frequency[2]", "Carrier frequency", 0 ],
			"obj-29::obj-2" : [ "Cutoff[2]", "Cutoff", 0 ],
			"obj-29::obj-3" : [ "Index[2]", "Index", 0 ],
			"obj-29::obj-4" : [ "Gain[2]", "Gain", 0 ],
			"obj-29::obj-6" : [ "Pan[2]", "Pan", 0 ],
			"obj-29::obj-7" : [ "live.numbox[2]", "live.numbox", 0 ],
			"obj-29::obj-8" : [ "Ratio[2]", "Ratio", 0 ],
			"parameterbanks" : 			{
